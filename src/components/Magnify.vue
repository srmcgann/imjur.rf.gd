      ...
      if(!this.$refs.magnifyingGlass.contains(this.contents)) {
        ...
        if(
          ...
          if(this.state.magLevel){
            ...
            this.contents.style.marginLeft = (-document.body.clientWidth/2 - this.state.mx + document.body.clientWidth/2) * (this.state.magLevel+1) + 200 + 397*((this.state.magLevel+1)-1) + (0*((this.state.magLevel+1)-1)) + 'px'
