    ...
    refresh(e){
      if(
        ...
        if(this.magLevel){
          ...
          this.contents.style.marginLeft = (-this.element.clientWidth/2 - this.mx + this.element.clientWidth/2) * this.magLevel + 200 + 395*(this.magLevel-1) + (100*(this.magLevel-1)) + 'px'
