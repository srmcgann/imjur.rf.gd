      ...
      if(this.$refs?.magnifyingGlass != null &&
        ...
        if(
          ...
          if(this.state.magLevel){
            ...
            this.contents.style.marginLeft = (-document.body.clientWidth/2 - this.state.mx + document.body.clientWidth/2) * (this.state.magLevel+1) + 210 + 400*((this.state.magLevel+1)-1) + 'px'
