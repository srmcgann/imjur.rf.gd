    ...
    refresh(e){
      if(
        ...
        if(this.magLevel){
          ...
          this.contents.style.marginLeft = ((this.element.clientWidth/2+(-this.mx-this.element.clientWidth/(1+this.magLevel)) + bounding.left-66*(this.magLevel-1))*this.magLevel + 200) + 'px'
