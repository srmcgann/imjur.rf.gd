      ...
      if(!this.$refs.magnifyingGlass.contains(this.contents)) {
        ...
        if(
          ...
          if(this.state.magLevel){
            ...
            this.contents.style.marginLeft = (-this.element.clientWidth/2 - this.state.mx + this.element.clientWidth/2) * (this.state.magLevel+1) + 200 + 397*((this.state.magLevel+1)-1) + (50*((this.state.magLevel+1)-1)) + 'px'
