      ...
      <div class="adminSection" v-if="state.adminData?.fileSizes">
        ...
        <table>
          ...
          <tr v-for="idx in sortedBySizes">
            ...
            <td v-else-if="state.adminData.filetypes[idx].indexOf('image')!=-1" class="td"><a :href="state.adminData.hrefs[idx]" target="_blank"><div :style="`background-image: url(${state.URLbase + '/' + state.adminData.hrefs[idx]});`" class="avatar"></div></a></td>
